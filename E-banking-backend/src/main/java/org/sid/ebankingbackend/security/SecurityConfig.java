...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager inMemoryUserDetailsManager(){
        ...
        return new InMemoryUserDetailsManager(
                User.withUsername("amine").password(passwordEncoder.encode("12345")).authorities("USER").build(),
                User.withUsername("admin-amine").password(passwordEncoder.encode("12345")).authorities("ADMIN").build()
        );
    }
    @Bean
